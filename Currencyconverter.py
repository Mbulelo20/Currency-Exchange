...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # placing
        self.from_currency_dropdown.grid(padx=65, pady=4)
        self.amount_field.grid(padx=80, pady=4)
        self.to_currency_dropdown.grid(padx=65, pady=6)
        # self.converted_amount_field.place(x = 346, y = 150)
        self.converted_amount_field_label.grid(padx=80, pady=4)

        # Convert button
        self.convert_button = Button(self, text="Convert", fg="black", command=self.perform)
        self.convert_button.config(font=('Courier', 10, 'bold'))
        self.convert_button.place(x=107, y=170)
